        ...
        <footer className="bg-windoor-primary text-white">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 px-6 sm:px-16 py-12 sm:py-16 lg:py-20 max-w-360 mx-auto">
                ...
                <div className="sm:col-span-2 md:col-span-1">
                    <div className="text-xl sm:text-2xl font-windoor-main uppercase tracking-tighter mb-6 sm:mb-8 text-white">Windoor</div>
                ...
                <div>
                    ...
                    <ul className="space-y-3 sm:space-y-4">
                        {[['/', 'Home'], ['/about', 'About'], ['/systems', 'Systems'], ['/projects', 'Projects'], ['/showrooms', 'Showrooms']].map(([to, label]) => (
                ...
                {/* Resources */}
                <div>
                    <h5 className="font-windoor-main text-xs uppercase tracking-widest text-white mb-6 sm:mb-8">Resources</h5>
                    <ul className="space-y-3 sm:space-y-4">
                        {['Technical Resources', 'Sustainability', 'CAD Downloads', 'Careers'].map((item) => (
                            <li key={item}><a href="#" className="font-windoor-main text-xs text-windoor-secondary hover:text-white transition-colors hover:underline underline-offset-4 decoration-1">{item}</a></li>
                        ))}
                    </ul>
                </div>
            ...
            <div className="px-6 sm:px-16 py-6 sm:py-8 border-t border-windoor-secondary/20 max-w-360 mx-auto flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
                <span className="font-windoor-main text-xs text-windoor-secondary text-center md:text-left">© 2024 Windoor Architectural Glazing Systems. All rights reserved.</span>
