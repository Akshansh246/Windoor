        ...
        <main className="pt-18">
            ...
            <section className="max-w-360 mx-auto px-6 sm:px-16 pt-20 sm:pt-28 lg:pt-32 mb-16 sm:mb-24 lg:mb-32">
                <div className="max-w-3xl">
                    <h1 className="text-xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font-windoor-main uppercase tracking-tighter leading-tight mb-6 sm:mb-8">Experience Precision.</h1>
            ...
            <section className="max-w-360 mx-auto px-6 sm:px-16 space-y-20 sm:space-y-32 lg:space-y-40 pb-20 sm:pb-32 lg:pb-40">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 group">
                    <div className="col-span-12 md:col-span-7 relative aspect-video md:aspect-video overflow-hidden border border-windoor-secondary bg-windoor-container-low">
                        <img alt="Ahmedabad Showroom" className="w-full h-full object-cover grayscale transition-transform duration-700 group-hover:scale-105" src={showrooms[0].img} />
                    </div>
                    <div className="col-span-12 md:col-span-5 flex flex-col justify-center py-4 sm:py-8">
                        ...
                        <h2 className="text-lg sm:text-3xl lg:text-4xl font-bold font-windoor-main mb-6 uppercase tracking-tight">Ahmedabad</h2>
                        <div className="space-y-5 border-l-2 border-windoor-primary pl-6 sm:pl-8">
                            <div>
                                ...
                                <p className="text-sm text-windoor-secondary">{showrooms[0].address}</p>
                            </div>
                    ...
                    <div className="col-span-12 h-40 sm:h-50  border border-windoor-secondary mt-4 sm:mt-8 relative overflow-hidden bg-windoor-container-low flex items-center justify-center opacity-40 hover:opacity-100 transition-opacity">
                         <iframe
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-8">
                    {showrooms.slice(1, 3).map((room) => (
                        <div key={room.id} className="space-y-6 sm:space-y-8 group">
                            <div className="aspect-square overflow-hidden border border-windoor-secondary bg-windoor-container-low relative">
                                <img alt={`${room.city} Showroom`} className="w-full h-full object-cover grayscale transition-transform duration-700 group-hover:scale-105" src={room.img} />
                                <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 bg-white/90 px-3 sm:px-4 py-2 border border-windoor-secondary">
                            ...
                            <div>
                                ...
                                <div className="space-y-4 border-l border-windoor-structural-grey pl-6">
                                    <p className="text-sm text-windoor-secondary">{room.address}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 group items-end">
                    <div className="col-span-12 md:col-span-4 order-2 md:order-1 py-4 sm:py-8">
                        ...
                        <div className="space-y-5 md:border-r-2 md:border-windoor-primary md:pr-8 md:text-right">
                            <div>
                                ...
                                <p className="text-sm text-windoor-secondary">{showrooms[3].address}</p>
                            </div>
                            <div>
                    ...
                    <div className="col-span-12 md:col-span-8 order-1 md:order-2 relative h-70 sm:h-100 lg:h-125 overflow-hidden border border-windoor-secondary">
                        <img alt="Mehsana Showroom" className="w-full h-full object-cover grayscale transition-transform duration-1000 group-hover:scale-110" src={showrooms[3].img} />
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-360 mx-auto px-6 sm:px-16 pb-16 sm:pb-24 lg:pb-40">
                <div className="bg-windoor-primary p-8 sm:p-16 md:p-24 text-center">
                    ...
                    <p className="text-windoor-secondary text-base sm:text-lg mb-8 sm:mb-12 max-w-2xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
                        <button className="bg-white text-windoor-primary px-8 sm:px-10 py-4 font-windoor-main text-xs uppercase tracking-widest hover:bg-windoor-container-low transition-colors">Download Catalog</button>
                        <button className="border border-windoor-secondary text-white px-8 sm:px-10 py-4 font-windoor-main text-xs uppercase tracking-widest hover:border-white transition-colors">Virtual Tour</button>
                    </div>
                </div>
            </section>
