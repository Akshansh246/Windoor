    ...
    return (
        <main className="pt-18">
            ...
            <header className="px-6 sm:px-16 max-w-360 mx-auto pt-20 sm:pt-28 lg:pt-32 mb-12 sm:mb-20">
                ...
                <h1 className="text-[26px] sm:text-4xl md:text-5xl lg:text-6xl font-bold font-windoor-main max-w-4xl text-windoor-primary leading-tight">Glazing Systems Engineered for Precision.</h1>
            ...
            <section className="px-6 sm:px-16 max-w-360 mx-auto space-y-16 sm:space-y-24 lg:space-y-32 pb-16 sm:pb-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 border-t border-windoor-structural-grey/40 pt-10 sm:pt-12">
                    <div className="md:col-span-4">
                        <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold font-windoor-main text-windoor-primary md:sticky top-32">Sliding Systems</h2>
                        <p className="text-windoor-secondary mt-4 text-sm">{systems[0].desc}</p>
                    </div>
                    <div className="md:col-span-8 space-y-6 sm:space-y-8">
                        <img className="w-full aspect-video object-cover grayscale brightness-95" src={systems[0].img} alt="Sliding Systems" />
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {systems[0].specs.map((spec) => (
                                <div key={spec.num} className={`p-6 sm:p-8 border border-windoor-secondary hover:border-windoor-primary transition-colors cursor-pointer group ${spec.wide ? 'sm:col-span-2' : ''}`}>
                                    ...
                                    <p className="text-windoor-secondary text-sm group-hover:text-windoor-primary transition-colors">{spec.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 border-t border-windoor-structural-grey/40 pt-10 sm:pt-12">
                    <div className="md:col-span-4">
                        <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold font-windoor-main text-windoor-primary md:sticky top-32">Casement Systems</h2>
                        <p className="text-windoor-secondary mt-4 text-sm">{systems[1].desc}</p>
                    </div>
                    <div className="md:col-span-8">
                        <div className="space-y-4">
                            {systems[1].items.map((item, i) => (
                                <div key={i} className="border border-windoor-secondary">
                                    <button onClick={() => toggle(i)} className="flex justify-between items-center p-6 sm:p-8 cursor-pointer w-full text-left bg-windoor-container-low">
                                    ...
                                    {openItems[i] && (
                                        <div className="p-6 sm:p-8 pt-0 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 bg-windoor-container-low">
                                            <p className="text-windoor-secondary text-sm">{item.body}</p>
                                            {item.features && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 border-t border-windoor-structural-grey/40 pt-10 sm:pt-12">
                    <div className="md:col-span-12 mb-4 sm:mb-8">
                        <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold font-windoor-main text-windoor-primary">Minimalist Series</h2>
                    </div>
                    <div className="md:col-span-7 h-75 sm:h-100 lg:h-125 border border-windoor-secondary relative overflow-hidden group">
                        <img className="absolute inset-0 w-full h-full object-cover grayscale transition-transform duration-700 group-hover:scale-105" src={systems[2].img} alt="Minimalist Series" />
                        <div className="absolute inset-0 bg-linear-to-t from-black/60 to-transparent p-8 sm:p-12 flex flex-col justify-end">
                    ...
                    <div className="md:col-span-5 grid grid-rows-1 md:grid-rows-2 gap-6 sm:gap-8">
                        <div className="p-8 sm:p-12 border border-windoor-secondary flex flex-col justify-between bg-white hover:bg-windoor-container-low transition-colors">
                            <div>
                                <h4 className="text-lg sm:text-2xl font-windoor-main font-bold mb-2">NGS System</h4>
                                <p className="text-windoor-secondary text-sm">Next Generation Slender profiles featuring recessed floor tracks for a true flush-threshold finish.</p>
                            </div>
                        ...
                        <div className="p-8 sm:p-12 border border-windoor-secondary bg-windoor-charcoal text-white flex flex-col justify-center">
                            <h4 className="text-lg sm:text-2xl font-windoor-main font-bold mb-4">Engineering Excellence</h4>
                            <p className="text-windoor-secondary text-sm">Profiles as thin as 20mm with the capability to support glass panels weighing up to 1,000kg.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 border-t border-windoor-structural-grey/40 pt-10 sm:pt-12">
                    {specialized.map((s) => (
                        <div key={s.title} className="p-6 sm:p-8 border border-windoor-secondary hover:border-windoor-primary transition-colors">
                            ...
                            <p className="text-windoor-secondary text-sm mb-6 sm:mb-8">{s.desc}</p>
            ...
            <section className="px-6 sm:px-16 max-w-360 mx-auto py-12 sm:py-20 border-y border-windoor-structural-grey/40 bg-windoor-container-low">
                <div className="flex flex-col md:flex-row justify-between items-start gap-8 sm:gap-12">
                    <div className="max-w-md">
                        ...
                        <p className="text-windoor-secondary text-sm">All Windoor systems undergo rigorous testing in controlled environments to ensure they meet international standards for wind load, water tightness, and air permeability.</p>
                    </div>
