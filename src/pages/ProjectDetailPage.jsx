        ...
        <main className="pt-18">
            ...
            <section className="px-6 sm:px-16 max-w-360 mx-auto pt-20 sm:pt-24 mb-16 sm:mb-24 lg:mb-32">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-10 sm:mb-16 gap-6">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font-windoor-main leading-tight mb-6">Villa Zenith</h1>
            ...
            <section className="px-6 sm:px-16 max-w-360 mx-auto mb-16 sm:mb-24 lg:mb-40">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8">
                    <div className="col-span-12 md:col-span-4">
                        <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold font-windoor-main md:sticky top-32">The Vision of Transparency</h2>
                    </div>
            ...
            <section className="px-6 sm:px-16 max-w-360 mx-auto mb-16 sm:mb-24 lg:mb-40">
                <div className="grid grid-cols-12 gap-4 sm:gap-8">
                    <div className="col-span-12 md:col-span-8 aspect-4/3 overflow-hidden border border-windoor-secondary">
                        <img className="w-full h-full object-cover hover:scale-105 transition-transform duration-700"
                    ...
                    <div className="col-span-12 md:col-span-4 aspect-square bg-windoor-container overflow-hidden border border-windoor-secondary p-6 sm:p-12 flex flex-col justify-between">
                        <div>
                        ...
                        <p className="font-windoor-main text-xs text-windoor-secondary">Custom-milled drainage tracks hidden beneath the perimeter stone to ensure a perfectly level transition with zero step-up.</p>
                    </div>
                    {[
                        ...
                        <div key={i} className="col-span-12 md:col-span-4 aspect-square overflow-hidden border border-windoor-secondary">
                            <img className={`w-full h-full object-cover transition-all duration-500 ${g.grayscale ? 'grayscale hover:grayscale-0' : 'hover:scale-105 transition-transform duration-700'}`} src={g.img} alt={`Gallery ${i + 3}`} />
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section className="bg-windoor-container-low px-6 sm:px-16 py-16 sm:py-24 lg:py-32">
                <div className="max-w-360 mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-12">
                        <div className="p-6 sm:p-8 border border-windoor-secondary bg-white space-y-4">
                            <span className="font-windoor-main text-xs text-windoor-primary uppercase">Systems Used</span>
                            <ul className="space-y-2">
                                {specs[0].items.map((item) => (
                                    <li key={item} className="flex justify-between items-center border-b border-windoor-secondary pb-2">
                        ...
                        <div className="p-6 sm:p-8 border border-windoor-secondary bg-white space-y-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-sm text-windoor-secondary">{specs[1].desc}</p>
                            </div>
                        </div>
                        <div className="p-6 sm:p-8 border border-windoor-secondary bg-white space-y-4">
            ...
            {/* Next Project */}
            <section className="border-y border-windoor-structural-grey/40 overflow-hidden group cursor-pointer">
                <div className="px-6 sm:px-16 max-w-360 mx-auto py-12 sm:py-20 lg:py-24 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
                    <div>
                        ...
                        <h2 className="text-2xl sm:text-4xl lg:text-6xl font-bold font-windoor-main leading-tight group-hover:translate-x-4 transition-transform duration-500">The Obsidian Pavilion</h2>
                    </div>
                    <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full border border-windoor-primary flex items-center justify-center group-hover:bg-windoor-primary group-hover:text-white transition-all duration-500 shrink-0">
