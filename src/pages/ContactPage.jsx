    ...
    return (
        <main className="pt-18">
            ...
            <section className="px-6 sm:px-16 max-w-360 mx-auto pt-20 sm:pt-28 lg:pt-32 mb-12 sm:mb-20 lg:mb-32">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-end">
                    ...
                    <div className="md:col-span-4 pb-4">
                        <p className="text-base sm:text-lg text-windoor-secondary border-l-2 border-windoor-structural-grey pl-6 sm:pl-8 py-2">
            ...
            <section className="px-6 sm:px-16 max-w-360 mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 mb-16 sm:mb-32 lg:mb-40">
                ...
                {/* Form */}
                <div className="md:col-span-6 bg-windoor-container-low border border-windoor-structural-grey/40 p-6 sm:p-10 lg:p-12 relative overflow-hidden">
                ...
                <div className="md:col-span-6 space-y-6 sm:space-y-8">
                    <div className="h-60 sm:h-85 lg:h-100 w-full overflow-hidden relative group">
                        <img alt="Architectural Detailing" className="w-full h-full object-cover grayscale transition-transform duration-700 group-hover:scale-105"
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAcEncH6iwDghGa-L_TfTVJBRI2WRub725XwYtiA7qef3oo7HEh2UBZhXkRyPRY8nC-8DADeRLzJYkUE3DCsaPRke4Xx9SNy7ZqPIdJ41ZQOfeTtApOkZiNo8bjGpn4RLYEyWnBZaXzFTgKtUdOW4wYhTe-MxCmOPzc6dRneZ1oS4u4ZLtlcZI0fAyt4eRV-4beXkgFdzGDIVjxhI9w-oiPZuNM_Fk_gAV2Bh3bUxLS7uHUieCVkE0tVCqlz_Q6rHxsVkM4LTBvy6Y"
                        />
                        <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 bg-white/80 backdrop-blur px-3 sm:px-4 py-2 border border-windoor-secondary">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
                        {[
                            ...
                            <div key={c.title} className="border border-windoor-structural-grey/40 p-6 sm:p-8 bg-windoor-container-low">
            ...
            <section className="bg-windoor-primary py-16 sm:py-20 lg:py-24 px-6 sm:px-16 overflow-hidden relative">
                <div className="max-w-360 mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-20 items-center">
                    <div>
                        <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold font-windoor-main text-white mb-6 sm:mb-8">Download Technical Specifications</h2>
                        <p className="text-windoor-secondary text-base sm:text-lg mb-8 sm:mb-10 max-w-lg">Access our comprehensive library of CAD blocks, BIM models, and performance data sheets to integrate Windoor systems seamlessly into your designs.</p>
                        <div className="flex flex-wrap gap-4">
                            <button className="border border-white text-white px-6 sm:px-8 py-4 font-windoor-main text-xs uppercase tracking-widest hover:bg-white hover:text-windoor-primary transition-all">Partner Portal Login</button>
                    ...
                    <div className="aspect-square bg-windoor-secondary/10 border border-windoor-secondary/20 flex items-center justify-center p-8 sm:p-12">
